...
<div class="max-w-xl mx-auto">
    <div class="bg-white rounded-xl shadow p-8">
        <h2 class="font-bold text-xl text-gray-800 mb-6">Edit Service</h2>
        <form action="{{ route('admin.services.update', $service) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500">{{ $service->description }}</textarea>
            </div>
            <div class="mb-6">
